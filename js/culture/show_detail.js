$(document).ready(function(){if(document.querySelector("#show-detail-container")){function e(e){const t=Math.min(parseFloat(e)/2,5);const a=Math.floor(t);const s=t%1>=.5?1:0;const i=5-a-s;return["★".repeat(a)+"☆".repeat(s),"☆".repeat(i)]}function l(e){const t=/^(https?|ftp):\/\/[^\s/$.?#].[^\s]*$/i;return t.test(e)}const t=new URLSearchParams(window.location.search).get("tmdb_id");let o={};$.ajax({url:`https://api.jaychou.site/trakt/show/${t}`,type:"GET",dataType:"json",async:false,success:function(e){o=e.data},error:function(e){console.log(e)}});const i=e(o.rating);const r=o.share_link?'target="_blank"':"";var n=o.share_link||"#";const d=`
