$(document).ready(function(){if(document.querySelector("#movie-detail-container")){function e(e){let t=parseFloat(e)/2;if(t>4.3)t=5;const a=parseInt(t);const i=t-a;const s=5-a-Math.ceil(i);return["★".repeat(a)+"☆".repeat(i),"☆".repeat(s)]}function l(e){const t=/^(https?|ftp):\/\/[^\s/$.?#].[^\s]*$/i;return t.test(e)}const t=new URLSearchParams(window.location.search).get("tmdb_id");let o={};$.ajax({url:`https://api.jaychou.site/trakt/movie/${t}`,type:"GET",dataType:"json",async:false,success:function(e){o=e.data},error:function(e){console.log(e)}});const s=e(o.rating);const r=o.share_link?'target="_blank"':"";var n=o.share_link||"#";const c=`
